...
1) **Trigger**: In this project, we design some triggers in table to ensure consistency across reservations, payments, and ratings.
2) **BLOB**: BLOB we use for storing pictures first, we find it advantage and disadvantage as we show in PPT.
3) **Safe connection**: If account wants to get the authority he doesn’t have it, mysql will deny his request. Privilege separation is implemented using multiple database users.
4) **Checking query time in webpages**: To meet the requirement, we set a webpage to show the query time in administrator management page which uses for checking reservation.
5) **Admin management**: We give a lot management function for business admin to manage data through controlled interfaces.

### System Screenshots
![Screenshot 1](./docs/p1.jpg)
![Screenshot 2](./docs/p2.jpg)
![Screenshot 3](./docs/p3.jpg)
![Screenshot 4](./docs/p4.jpg)
---
